...
smith_image = face_recognition.load_image_file("Students/Smith.jpg")
smith_encoding = face_recognition.face_encodings(smith_image)[0]

known_face_encodings = [akshay_encoding , rahul_encoding , smith_encoding]
known_face_names = ["Akshay" , "Rahul" , "Smith"]
